                ...
                <div class="regulasi">
                    ...
                    <div class="d-flex">
                        <a id="toggleBtn" class="btn btn-secondary w-100" data-bs-toggle="collapse" href="#peraturan-presiden" role="button" aria-expanded="false" aria-controls="peraturan-presiden">
                            <h8>
                            <i id="icon" class="fas fa-plus"></i> &nbsp;&nbsp;Aspek 4 : Layanan Administrasi SPBE
                            </h8>
                        </a>
                    </div>
                    ...
                    <div class="collapse" id="peraturan-presiden">
                        <div class="card card-body">
                            <ul>
                                <li><a href="preview">Indikator 10 : Layanan Perencaaan</a></li>
                                <li><a href="preview">Indikator 11 : Layanan Perencaaan</a></li>
                                <li><a href="preview">Indikator 12 : Layanan Perencaaan</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="container mt-2">
                        <div class="d-flex">
                            <a class="btn btn-secondary w-100" data-bs-toggle="collapse" href="#peraturan-menteri" role="button" aria-expanded="false" aria-controls="peraturan-menteri">
                                <h8>
                                <i class="fas fa-plus"></i> &nbsp;&nbsp;Aspek 4 : Layanan Administrasi SPBE
                                </h8>
                            </a>
                        </div>
