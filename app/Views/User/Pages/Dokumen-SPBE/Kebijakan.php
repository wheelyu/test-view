...
<?= $this->section('content'); ?>
    ...
    <div class="about">
        ...
        <div class="breadcrumbs"style="width: 440px;">
                ...
                <a>Domain SPBE</a>
                <i class="fa fa-angle-right"></i>
                <a class="active">Kebijakan SPBE</a>
            </div>
        </div>
        <br><br><br><br><br><br>
        <div class="container mt-5">
                ...
                <div class="regulasi">
                    ...
                    <div class="d-flex">
                        <a id="toggleBtn" class="btn btn-secondary w-100" data-bs-toggle="collapse" href="#peraturan-presiden" role="button" aria-expanded="false" aria-controls="peraturan-presiden">
                            <h8>
                            <i id="icon" class="fas fa-plus"></i> &nbsp;&nbsp;Aspek 1 : Kebijakan Internal Terkait Tata Kelola SPBE
                            </h8>
                        </a>
                    </div>
                    ...
                    <div class="collapse" id="peraturan-presiden">
                        <div class="card card-body">
                            <ul>
                                <li><a href="preview">Indikator 1 : Kebijakan Internal Arsitektur SPBE Pemerintah Daerah</a></li>
                                <li><a href="preview">Indikator 2 : Kebijakan Internal Arsitektur SPBE Pemerintah Daerah</a></li>
                                <li><a href="preview">Indikator 3 : Kebijakan Internal Arsitektur SPBE Pemerintah Daerah</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="container mt-2">
                        <div class="d-flex">
                            <a class="btn btn-secondary w-100" data-bs-toggle="collapse" href="#peraturan-menteri" role="button" aria-expanded="false" aria-controls="peraturan-menteri">
                                <h8>
                                <i class="fas fa-plus"></i> &nbsp;&nbsp;Aspek 1 : Kebijakan Internal Terkait Tata Kelola SPBE
                                </h8>
                            </a>
                        </div>
